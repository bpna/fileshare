...
enum message_type {NEW_CLIENT = 1, NEW_CLIENT_ACK, ERROR_CLIENT_EXISTS,
                   ...
                   CREATE_CLIENT_ACK, NEW_SERVER, NEW_SERVER_ACK, 
                   ERROR_SERVER_EXISTS, UPLOAD_FILE = 128, UPLOAD_ACK, 
                   ERROR_FILE_EXISTS, ERROR_UPLOAD_FAILURE, REQUEST_FILE, 
                   RETURN_FILE, UPDATE_FILE, UPDATE_ACK, CHECKOUT_FILE, 
                   ERROR_FILE_DOES_NOT_EXIST, ERROR_BAD_PERMISSIONS, 
                   ERROR_INVALID_FNAME, FILE_LIST, FILE_LIST_ACK};
