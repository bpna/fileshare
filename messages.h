...
enum message_type {NEW_CLIENT = 1, NEW_CLIENT_ACK, ERROR_CLIENT_EXISTS,
                   REQUEST_USER, REQUEST_USER_ACK, ERROR_USER_DOES_NOT_EXIST,
                   CREATE_CLIENT = 64, CREATE_CLIENT_ACK, CREATE_CLIENT_ERROR,
                   NEW_SERVER, NEW_SERVER_ACK, ERROR_SERVER_EXISTS,
                   NEW_PERSONAL_SERVER, NEW_PERSONAL_SERVER_ACK,
                   UPLOAD_FILE = 128, UPLOAD_ACK, ERROR_FILE_EXISTS,
                   ERROR_UPLOAD_FAILURE, REQUEST_FILE, RETURN_READ_ONLY_FILE,
                   UPDATE_FILE, UPDATE_ACK, CHECKOUT_FILE, DELETE_FILE, DELETE_FILE_ACK,
                   ERROR_FILE_DOES_NOT_EXIST, ERROR_BAD_PERMISSIONS,
                   ERROR_INVALID_FNAME, RETURN_CHECKEDOUT_FILE};
